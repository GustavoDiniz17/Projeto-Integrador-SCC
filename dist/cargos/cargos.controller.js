...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Lista de cargos retornada com sucesso' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Cargos encontrados' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Cargo encontrado' }),
